    ...
    <div class="p-3 sm:p-6">
        ...
        <div class="items-center mb-6">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                ...
                <input type="text" wire:model.debounce.500ms="search" placeholder="Search" class="w-full sm:w-72 rounded-lg border border-slate-300
                       px-4 py-2 shadow-sm
                            ...
                            : '-'); ?>
                                                ...
                                                <td class="px-6 py-4">
                                                    ...
                                                    <div class="flex justify-center gap-2">
                                                        ...
                                                        <button wire:click="edit('<?php echo e($pengguna->nip); ?>')" class="bg-[#0070C0] hover:bg-[#005B9F]
                                                        ...
                                                        <button wire:click="confirmDelete('<?php echo e($pengguna->nip); ?>')" class="bg-red-500 hover:bg-red-600
                                                                                       text-white px-4 py-2
                                                                                       rounded-lg text-xs
                                                                                       font-semibold shadow">
...
</div><?php /**PATH C:\laragon\www\sistem-broadcast\resources\views/livewire/employed/pengguna.blade.php ENDPATH**/ ?>