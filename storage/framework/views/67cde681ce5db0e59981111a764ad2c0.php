                            ...
                            <tr class="hover:bg-blue-50 transition duration-200">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <button wire:click="edit('<?php echo e($jabatan->id); ?>')" class="bg-[#0070C0] hover:bg-[#005B9F]
                                        ...
                                        <button wire:click="confirmDelete('<?php echo e($jabatan->id); ?>')" class="bg-red-500 hover:bg-red-600
                                                                                   text-white px-4 py-2
                                                                                   rounded-lg text-xs
                                                                                   font-semibold shadow">
...
</div><?php /**PATH C:\laragon\www\sistem-broadcast\resources\views/livewire/employed/jabatan.blade.php ENDPATH**/ ?>