                ...
                <table class="w-full border-collapse">
                    ...
                    <tbody class="bg-white divide-y divide-slate-200">
                            ...
                            <tr class="hover:bg-blue-50 transition duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center items-center gap-2 flex-nowrap">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($task->status == 'submitted' && auth()->user()?->isAsmen() && (auth()->user()?->nip == $task->project?->asmen_id)): ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr wire:key="task-<?php echo e($task->id); ?>">
